...
fun osVersionInfo(): OSVersionInfo {
  ...
  val codename = if (Build.VERSION.CODENAME == releaseCodename) stringResource(R.string.codename_release) else stringResource(
    R.string.codename,
  ...
  val type =
    if (isPreview) stringResource(R.string.type_beta_preview_version, previewSdkVersion) else stringResource(R.string.type_stable_release)
